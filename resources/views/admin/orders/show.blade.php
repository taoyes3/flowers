                    ...
                    <td colspan="4">
                        <form action="{{ route('admin.orders.ship', [$order]) }}" method="post" class="form-inline">
                            ...
                            <div class="form-group {{ $errors->has('express_company') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="express_company" class="form-control" id="express_company" placeholder="输入物流公司" value="">
                            ...
                            <div class="form-group {{ $errors->has('express_no') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="express_no" id="express_no" class="form-control" value="" placeholder="输入物流单号">
